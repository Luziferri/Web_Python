...
Projeto final - Unidade curricular: Desenvolvimento de Aplicações Web (DAW)
...
passlib
```
>>>>>>> cb7e4d20a21bdf1013e8f25000f56498ef745e39
...
3. No Dashboard:
   - **Mover o Steve**: setas, teclas A/D ou botões na interface
...
## Grupo
Bernardo Campos, Inês Medeiros, Ricardo Janz.